                                ...
                                <div class="padded-box">
                                    <div class="card">
                                        ...
                                        <div class="card-footer">
                                            <a @click="reAuth(item.icon)" class="button is-primary card-footer-item" v-if="item.type === 'button'" v-bind:class="{ 'is-loading': authUI.pending }" id="quickstart-sign-in">
                                                <i :class="'fa fa-pull-left fa-' + item.icon"></i> Reauthenticate
                                            </a>
                                        </div>
                                    </div>
                                </div>
