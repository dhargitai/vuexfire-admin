<template>
    <div class="notes">
        ...
        <article class="media" v-if="!completed" v-for="(note, index) in incompletedNotes" v-bind:index="index" v-bind:key="note.id">
        ...
        <!-- Completed Notes -->
        <!-- <transition-group name="scaleFade"> -->
        <article class="media notes-completed" v-if="completed" v-for="(note, index) in completedNotes" v-bind:index="index" v-bind:key="note.id">
            <div class="media-content">
...
.notes-completed .text {
    text-decoration: line-through;
}


.loadingDog-enter-active,
.loadingDog-leave-active {
    opacity: 1;
    transform: scale(1);
